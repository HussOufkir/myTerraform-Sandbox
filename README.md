...
- [Structure & syntax](https://github.com/HussOufkir/myTerraform-Sandbox#structure--syntax)
  ...
  - [List of files](https://github.com/HussOufkir/myTerraform-Sandbox#list-of-files)

- [Commands](https://github.com/HussOufkir/myTerraform-Sandbox#commands)
  - [Apply](https://github.com/HussOufkir/myTerraform-Sandbox#apply)
  - [Destroy](https://github.com/HussOufkir/myTerraform-Sandbox#destroy)
  - [Plan](https://github.com/HussOufkir/myTerraform-Sandbox#plan)

- [Terraform Cloud](https://github.com/HussOufkir/myTerraform-Sandbox#terraform-cloud)

- [Debugging](https://github.com/HussOufkir/myTerraform-Sandbox#debugging)

- [How-to](https://github.com/HussOufkir/myTerraform-Sandbox#how-to)
  - [Connect to AWS](https://github.com/HussOufkir/myTerraform-Sandbox#connect-to-aws)

- [Tips](https://github.com/HussOufkir/myTerraform-Sandbox#tips)
  - [Terminal commands inside an instance](https://github.com/HussOufkir/myTerraform-Sandbox#terminal-commands-inside-an-instance)

- [To-do list](https://github.com/HussOufkir/myTerraform-Sandbox#to-do-list)

- [Links](https://github.com/HussOufkir/myTerraform-Sandbox#links)
